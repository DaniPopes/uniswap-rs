...
/// Represents a decentralized, on-chain exchange protocol.
...
pub enum Protocol {
    ...
    /// Custom protocol wrapping (router_address, factory_address)
...
impl Protocol {
    ...
    pub fn get_pair_codehash(&self) -> H256 {
        match self {
            ...
            Protocol::Pancakeswap => PANCAKESWAP_PAIR_CODE_HASH,
