...
pub mod i_universal_router_commands {
    ...
    pub static IUNIVERSALROUTERCOMMANDS_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
        ethers::contract::Lazy::new(|| {
            ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi")
        });
    pub struct IUniversalRouterCommands<M>(ethers::contract::Contract<M>);
    ...
    impl<M: ethers::providers::Middleware> IUniversalRouterCommands<M> {
        ...
        pub fn crypto_punks(
            &self,
            punk_id: ethers::core::types::U256,
    ...
    pub struct CryptoPunksCall {
        pub punk_id: ethers::core::types::U256,
    ...
    pub struct PayPortionCall {
        pub token: ethers::core::types::Address,
        pub recipient: ethers::core::types::Address,
        pub bips: ethers::core::types::U256,
    }
    ...
    impl ethers::core::abi::AbiDecode for IUniversalRouterCommandsCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::std::result::Result<Self, ethers::core::abi::AbiError> {
            if let Ok(decoded) =
                <CryptoPunksCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::CryptoPunks(decoded))
            }
            if let Ok(decoded) =
                <FoundationCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::Foundation(decoded))
            }
            if let Ok(decoded) =
                <LooksRare1155Call as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::LooksRare1155(decoded))
            }
            if let Ok(decoded) =
                <LooksRare721Call as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::LooksRare721(decoded))
            }
            if let Ok(decoded) = <Nft20Call as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::Nft20(decoded))
            }
            if let Ok(decoded) = <NftxCall as ethers::core::abi::AbiDecode>::decode(data.as_ref()) {
                return Ok(IUniversalRouterCommandsCalls::Nftx(decoded))
            }
            if let Ok(decoded) =
                <OwnerCheck1155Call as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::OwnerCheck1155(decoded))
            }
            if let Ok(decoded) =
                <OwnerCheck721Call as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::OwnerCheck721(decoded))
            }
            if let Ok(decoded) =
                <PayPortionCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::PayPortion(decoded))
            }
            if let Ok(decoded) =
                <Permit2PermitCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::Permit2Permit(decoded))
            }
            if let Ok(decoded) =
                <Permit2PermitBatchCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::Permit2PermitBatch(decoded))
            }
            if let Ok(decoded) =
                <Permit2TransferFromCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::Permit2TransferFrom(decoded))
            }
            if let Ok(decoded) =
                <Permit2TransferFromBatchCall as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
            ...
            if let Ok(decoded) =
                <SeaportCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::Seaport(decoded))
            }
            if let Ok(decoded) =
                <SudoSwapCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
            ...
            if let Ok(decoded) =
                <SweepErc1155Call as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::SweepErc1155(decoded))
            }
            if let Ok(decoded) =
                <SweepErc721Call as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
            ...
            if let Ok(decoded) =
                <UnwrapEthCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::UnwrapEth(decoded))
            }
            if let Ok(decoded) =
                <V2SwapExactInCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::V2SwapExactIn(decoded))
            }
            if let Ok(decoded) =
                <V2SwapExactOutCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::V2SwapExactOut(decoded))
            }
            if let Ok(decoded) =
                <V3SwapExactInCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::V3SwapExactIn(decoded))
            }
            if let Ok(decoded) =
                <V3SwapExactOutCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::V3SwapExactOut(decoded))
            }
            if let Ok(decoded) =
                <WrapEthCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::WrapEth(decoded))
            }
            if let Ok(decoded) =
                <X2Y21155Call as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IUniversalRouterCommandsCalls::X2Y21155(decoded))
            }
            if let Ok(decoded) =
                <X2Y2721Call as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
    ...
    impl ethers::core::abi::AbiEncode for IUniversalRouterCommandsCalls {
